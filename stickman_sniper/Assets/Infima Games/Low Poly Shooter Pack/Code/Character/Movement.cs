...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Movement : MovementBehaviour
    {
        ...
        {
            //Get Movement Input!
            Vector3 targetVelocity = new(_inputService.XAxis, 0, _inputService.ZAxis);
            Vector3 frameInput = Vector3.ClampMagnitude(targetVelocity, 1.0f);
            //Calculate local-space direction by using the player's input.
            var desiredDirection = new Vector3(frameInput.x, 0.0f, frameInput.z);
